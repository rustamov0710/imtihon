...
<footer className='bg-gray-50'>
  <div className="container flex mt-[100px]">
    <ul className='flex items-center'>
      <li className="flex flex-col items-start p-6 border-r">
        ...
        <p className="mt-2 text-[14px] text-gray-600 text-start w-[204px]">
      ...
      <li className="flex flex-col items-start p-6">
        <div className="bg-green-100 p-2 rounded-full">
  ...
  <div className="container bg-gray-100 p-[25px] flex items-center">
  ...
  <div className="container flex items-center mt-[33px]">
    <ul className="flex items-center gap-[185px]">
    ...
    <div className="flex flex-col items-start space-y-6 ml-[175px] my-[33px]">
